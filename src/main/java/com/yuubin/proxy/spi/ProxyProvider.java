...
/**
 * Service Provider Interface (SPI) for creating custom Proxy Server implementations.
 * Third-party plugins should implement this interface and register it in
 * META-INF/services/com.yuubin.proxy.spi.ProxyProvider.
 */
public interface ProxyProvider {
    /**
     * Retrieves the protocol type this provider supports.
     * <p>Example values: "HTTP", "SOCKS5". This corresponds to the 'type' field in the configuration.</p>
     ...
     */
    ProxyServer create(ProxyServerConfig config, AuthService auth, LoggingService log, MeterRegistry registry, YuubinProperties global);
}
